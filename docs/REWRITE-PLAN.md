...
| D1 | Docs automation like scooter's xtask: declarative options table as single source of truth, xtask readme generator (TOC/CONFIG/KEYS markers, core keys.rs doc parsing via cargo metadata), CI --check job | in progress |
