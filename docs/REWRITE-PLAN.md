...
| SH1 | Highlight engine: language detection (languages.toml + fallback map), grammar/query loading with inherits + caching, spans API, scope:<name> run tags resolved in Steel | in progress |
