...
| PAR1 | TUI parity sweep: A-e collision fix (bg-open becomes configurable plugin.open_in_editor_bg, default A-o), paste support, META/SUPER modifiers, help-row injection, interception contract test, config-matrix e2e | done |
